...
class TvAudiobookPlayerParitySourceTest {
    private val playerSource = File(
        "src/androidMain/kotlin/org/siloserver/silo/tv/ui/screens/audiobook/TvAudiobookPlayerScreen.kt",
    ).readText()
    private val transportSource = File(
        "src/androidMain/kotlin/org/siloserver/silo/tv/ui/screens/audiobook/TvAudiobookTransportRow.kt",
    ).readText()
