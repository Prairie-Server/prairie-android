...
class TvProfileActionsPanelReadabilityTest {
    ...
    fun focusedProfileRowsInvertTextAgainstLightFocusBackground() {
        // TvProfileDropdown rows invert to a solid SiloOnSurface fill with
        ...
        assertTrue(source.contains("if (isFocused) DarkBackground else SiloOnSurface.copy(alpha = 0.9f)"))
    }
