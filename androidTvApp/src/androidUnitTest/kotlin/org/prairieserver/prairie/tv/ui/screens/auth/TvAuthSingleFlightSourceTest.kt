...
class TvAuthSingleFlightSourceTest {
    ...
    private val setupViewModel = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/auth/TvSetupViewModel.kt",
    ).readText()
    private val signupViewModel = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/auth/TvSignupViewModel.kt",
    ).readText()
    private val auroraChrome = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvAuroraChrome.kt",
    ).readText()
    private val heroActionPill = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvHeroActionPill.kt",
    ).readText()
