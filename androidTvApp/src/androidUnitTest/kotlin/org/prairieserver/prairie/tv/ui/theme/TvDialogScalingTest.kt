...
class TvDialogScalingTest {
    ...
    private val pinEntryDialog = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvPinEntryDialog.kt",
    ).readText()
    ...
    private val ratingDialog = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvRatingDialog.kt",
    ).readText()

    private val mediaInfoDialog = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvMediaInfoDialog.kt",
    ).readText()
    ...
    private val subtitleSearchDialog = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/player/TvSubtitleSearchDialog.kt",
    ).readText()

    private val audiobookOverlay = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/audiobook/TvAudiobookOverlay.kt",
    ).readText()

    private val watchTogetherEntryDialog = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/watchtogether/TvWatchTogetherEntryDialog.kt",
    ).readText()

    private val joinCodeDialog = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/watchtogether/TvJoinCodeDialog.kt",
    ).readText()
