package org.prairieserver.prairie.tv.ui.performance
...
class TvListPerformanceSourceTest {
    ...
    private val catalogGrid = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvCatalogGrid.kt",
    ).readText()
    ...
    private val recommendations = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/recommendations/TvRecommendationsScreen.kt",
    ).readText()

    private val cardActionsHelpers = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvCardActionsHelpers.kt",
    ).readText()
    ...
    private val heroCarousel = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvHomeHeroCarousel.kt",
    ).readText()

    private val requestsScreen = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/requests/TvRequestsScreen.kt",
    ).readText()
