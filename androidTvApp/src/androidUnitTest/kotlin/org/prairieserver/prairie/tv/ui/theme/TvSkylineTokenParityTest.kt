...
class TvSkylineTokenParityTest {
    private val spacing = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/theme/Spacing.kt",
    ).readText()
    ...
    private val panelChrome = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvSkylinePanelChrome.kt",
    ).readText()

    private val mediaCard = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvMediaCard.kt",
    ).readText()

    private val episodeCard = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvEpisodeCard.kt",
    ).readText()

    private val mediaRow = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvMediaRow.kt",
    ).readText()

    private val focusMarquee = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvFocusMarquee.kt",
    ).readText()

    private val homeScreen = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/home/TvHomeScreen.kt",
    ).readText()

    private val skylineSectionFeed = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvSkylineSectionFeed.kt",
    ).readText()

    private val browseScreen = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/browse/TvBrowseScreen.kt",
    ).readText()

    private val libraryDetailScreen = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/library/TvLibraryDetailScreen.kt",
    ).readText()

    private val playerTransportCluster = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/player/TvPlayerTransportCluster.kt",
    ).readText()

    private val playerScrubber = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/player/TvPlayerScrubber.kt",
    ).readText()
    ...
    private val cardOverlaySettingsScreen = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/settings/TvCardOverlaySettingsScreen.kt",
    ).readText()
    ...
    private val detailEpisodeRail = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvDetailEpisodeRail.kt",
    ).readText()

    private val detailSectionHeader = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvDetailSectionHeader.kt",
    ).readText()
    ...
    private val castCrewSection = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvCastCrewSection.kt",
    ).readText()

    private val anchoredSelectorMenu = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvAnchoredSelectorMenu.kt",
    ).readText()

    private val detailFactsTable = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvDetailFactsTable.kt",
    ).readText()
