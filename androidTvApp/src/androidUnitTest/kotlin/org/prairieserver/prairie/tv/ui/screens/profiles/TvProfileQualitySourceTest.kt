...
class TvProfileQualitySourceTest {
    private val createViewModel = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/profiles/TvCreateProfileViewModel.kt",
    ).readText()
    private val editViewModel = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/profiles/TvEditProfileViewModel.kt",
    ).readText()
    @Test
