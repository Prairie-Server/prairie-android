...
class TvDetailOpenPerformanceSourceTest {
    private val viewModel = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvItemDetailViewModel.kt",
    ).readText()
    ...
    private val seasonPicker = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvSeasonPicker.kt",
    ).readText()
