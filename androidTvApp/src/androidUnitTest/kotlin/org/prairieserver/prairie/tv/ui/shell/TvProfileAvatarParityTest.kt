...
class TvProfileAvatarParityTest {
    ...
    private val topMenu = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/shell/TvTopMenuBar.kt",
    ).readText()

    @Test
    fun accountSnapshotResolvesProfileAvatarImageUrlsForTopChrome() {
        assertTrue(shell.contains("import org.prairieserver.prairie.common.ui.components.isImageAvatar"))
        assertTrue(shell.contains("import org.prairieserver.prairie.common.ui.components.resolveAvatarUrl"))
