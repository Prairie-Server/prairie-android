...
class TvCardOverlayScaleSourceTest {
    ...
    private val sharedCardOverlaysSource = File(
        "../android-shared/src/androidMain/kotlin/org/prairieserver/prairie/common/overlays/CardOverlays.kt",
    ).readText()

    private val sharedBadgeSource = File(
        "../android-shared/src/androidMain/kotlin/org/prairieserver/prairie/common/overlays/OverlayBadge.kt",
    ).readText()

    private val sharedPresetSource = File(
        "../android-shared/src/androidMain/kotlin/org/prairieserver/prairie/common/overlays/OverlayPresetStyle.kt",
    ).readText()
    ...
    fun tvOverlaySettingsPreviewUsesSameTvScaleAndOpacity() {
        assertTrue(tvSettingsSource.contains("import org.prairieserver.prairie.tv.ui.components.TvCardOverlayScale"))
