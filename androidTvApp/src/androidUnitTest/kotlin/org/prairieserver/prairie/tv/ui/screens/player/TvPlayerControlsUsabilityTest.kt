...
class TvPlayerControlsUsabilityTest {
    ...
    private val activitySource = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/MainTvActivity.kt",
    ).readText()
    private val routeSource = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/navigation/TvRoute.kt",
    ).readText()
    private val navigationSource = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/navigation/TvAppNavigation.kt",
    ).readText()
    private val remoteKeyBridgeSource = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/player/TvPlayerRemoteKeyBridge.kt",
    ).takeIf { it.exists() }?.readText().orEmpty()
    private val searchSource = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/search/TvSearchScreen.kt",
    ).readText()
    private val playbackSelectorSource = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvPlaybackSelectorRow.kt",
    ).readText()
    private val playbackFormattingSource = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/detail/TvPlaybackFormatting.kt",
    ).readText()
    private val fullScreenPickerFile = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvFullScreenPicker.kt",
    )
    ...
    private val optionDialogSource = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/components/TvOptionDialog.kt",
    ).readText()
    ...
    private val aiTranslateSource = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/player/TvAiTranslateDialog.kt",
    ).readText()
    ...
    fun playNextCarriesCurrentQualityToNextEpisodeRoute() {
        val starterSource = File(
            "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/player/TvVideoPlaybackStarter.kt",
        ).readText()
    ...
    fun holdSeekIndicatorUsesVerticalChipOverBarOverHintLayout() {
        val holdSeekSource = File(
            "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/screens/player/TvHoldSeekIndicator.kt",
        ).readText()
