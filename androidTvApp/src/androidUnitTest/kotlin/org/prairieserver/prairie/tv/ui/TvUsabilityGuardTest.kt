package org.prairieserver.prairie.tv.ui
...
class TvUsabilityGuardTest {
    private val tvSourceRoot = File("src/androidMain/kotlin/org/prairieserver/prairie/tv")
    ...
    fun secondaryUtilityScreensStayOutOfTheTopTabBar() {
        val destinations = File(
            "src/androidMain/kotlin/org/prairieserver/prairie/tv/ui/shell/TvMediaDestinations.kt",
        ).readText()
