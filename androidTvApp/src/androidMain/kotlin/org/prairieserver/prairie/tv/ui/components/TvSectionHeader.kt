...
import org.prairieserver.prairie.tv.ui.theme.prairieFocus
...
fun TvSectionHeader(
    ...
    /** Optional uppercase eyebrow rendered above the title (e.g. "PRAIRIE PICKS"). */
    eyebrow: String? = null,
) {
    Row(
        modifier = modifier
        ...
        if (onSeeAllClick != null) {
            ...
            Row(
                modifier = Modifier
                    .prairieFocus(interactionSource)
                    .clickable(
