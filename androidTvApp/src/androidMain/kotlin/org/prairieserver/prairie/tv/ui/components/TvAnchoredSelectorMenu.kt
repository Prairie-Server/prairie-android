...
// ---------------------------------------------------------------------------
// Anchored selector popover — Compose-for-TV port of the prairie-apple tvOS
            ...
            options.forEach { option ->
                ...
                DropdownMenuItem(
                    ...
                    colors = MenuDefaults.itemColors(
                        textColor = PrairieOnSurface,
                        leadingIconColor = PrairieOnSurface,
                        disabledTextColor = PrairieOnSurface.copy(alpha = 0.38f),
                        disabledLeadingIconColor = PrairieOnSurface.copy(alpha = 0.38f),
                    ),
                    onClick = {
                        option.onSelect()
                        expanded = false
