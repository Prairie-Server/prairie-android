...
/**
 * Full-screen TV player. The ExoPlayer itself lives in [PrairiePlaybackService];
...
fun TvPlayerScreen(
    ...
    DisposableEffect(context) {
        ...
        onDispose {
            ...
            // PrairiePlaybackService keeps running (background playback after
    ...
    DisposableEffect(context) {
        onDispose {
            pictureInPictureCoordinator.clearPlaybackState(context as? Activity, PrairiePictureInPictureSurface.Tv)
        }
    }
