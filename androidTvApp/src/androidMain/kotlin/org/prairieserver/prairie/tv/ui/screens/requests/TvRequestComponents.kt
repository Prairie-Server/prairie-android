...
import org.prairieserver.prairie.model.request.RequestOutcome
import org.prairieserver.prairie.model.request.RequestStatus
import org.prairieserver.prairie.model.request.badgeStatus
...
import org.prairieserver.prairie.model.request.targetSummary
import org.prairieserver.prairie.tv.ui.components.TvCardWidth
...
fun TvRequestStatusChip(
    ...
    val (background, foreground) = when (normalized.lowercase()) {
        RequestAvailability.Available, RequestStatus.Completed -> PrairieBlue to DarkOnPrimary
