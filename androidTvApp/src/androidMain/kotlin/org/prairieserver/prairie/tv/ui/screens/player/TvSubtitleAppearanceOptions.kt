 ...
 * ([org.prairieserver.prairie.tv.ui.screens.settings.TvSettingsScreen]). The HUD and
 * Settings must offer identical choices, so both lift these from here rather
 * than defining their own. Hex palettes match the prairie-apple
...
object TvSubtitleAppearanceOptions {
     ...
     *  5, matching prairie-apple `TVSettingsOptions.backgroundOpacity`. */
    ...
    /** Outline color palette: matches prairie-apple `SubtitleAppearance.outlineColors`,
