 ...
 *
 * Classification reuses the shared [org.prairieserver.prairie.model.navigation]
...
enum class TvLibraryTabType {
     ...
     * (§5.3). Drawn from the same icon set [org.prairieserver.prairie.tv.ui.screens.libraries]
