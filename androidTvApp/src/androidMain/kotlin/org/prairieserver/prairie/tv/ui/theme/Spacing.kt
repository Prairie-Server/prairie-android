...
/**
 * tvOS-faithful spacing scale. Values mirror PrairieTheme.swift for the tvOS
...
/**
 * Skyline top-bar chrome metrics, mirrored from `PrairieTheme.Skyline` in
 * `iosApp/iosApp/Theme/PrairieTheme.swift`. tvOS values are points at
 ...
 * proportions. Text keeps the TV font scale supplied by [PrairieTvTheme].
...
object TvSkyline {
     ...
     * renders it for Android (`res/drawable/prairie_wordmark.png`, 764x400). Branding
