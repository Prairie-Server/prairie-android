...
data class TvMarqueeContent(
    ...
    companion object {
         ...
         */
        internal fun qualityBadges(summary: org.prairieserver.prairie.model.catalog.OverlaySummary?): List<String> {
 ...
 *  names sorted by [org.prairieserver.prairie.model.catalog.CastMember.order], joined
