 ...
 *   - Server-side codec identifiers in `Continuum/internal/playback/`
 *
...
object FfmpegAudioSupport {
    /**
     * Short codec codes emitted into [com.continuum.app.model.playback.ClientCodecCapabilities.codecsAudio]
