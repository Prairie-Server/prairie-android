...
import org.prairieserver.prairie.common.player.ActivePlaybackFile
 ...
 * have Room on their compile classpath — they can name [PrairieDatabase] but not
 * call through it.
 */
fun installOrphanedServerDataPurge(
    context: Context,
    registry: ServerRegistry,
    database: PrairieDatabase,
