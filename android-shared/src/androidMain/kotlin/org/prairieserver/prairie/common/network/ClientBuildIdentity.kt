 ...
 * server, on any carrier (the `X-Prairie-Client-Build` header, the v3 client
 ...
 * client identity: the metadata provider behind the `X-Prairie-Client-*` headers,
 ...
 */
data class PrairieClientBuildIdentity(
