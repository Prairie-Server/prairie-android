...
internal data class PrairieMediaTransformTag(
...
/** JNI bridge to the pinned libdovi build packaged in prairie-dovi-bridge. */
@Keep
internal object NativeDolbyVisionRpuConverter : DolbyVisionRpuConverter {
    private val loaded: Boolean = runCatching {
        System.loadLibrary("prairie_dovi")
        nativeIsReady()
    }.onFailure { Log.w("PrairieDovi", "libdovi bridge unavailable", it) }
        .getOrDefault(false)
