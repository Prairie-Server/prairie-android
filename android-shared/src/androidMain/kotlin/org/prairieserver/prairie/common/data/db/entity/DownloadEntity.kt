...
/**
 * Room projection of a [org.prairieserver.prairie.model.download.DownloadSidecar]
 * (server [org.prairieserver.prairie.model.download.DownloadRecord] + the catalog
