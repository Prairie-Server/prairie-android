...
class FileDiagnosticsCaptureController(
    ...
    private val sessionIdFactory: () -> String = { PrairieLog.captureSessionId },
    ...
    override fun closeGate() {
        ...
        PrairieLog.installSink(logBuffer)
    ...
    override suspend fun start(context: DiagnosticsCaptureContext): ActiveDiagnosticsCapture {
        ...
        PrairieLog.installSink(FanOutDiagnosticsLogSink(logBuffer, fileLogger))
