...
namespace {
constexpr const char *kVersion = "prairie-dovi-1/libdovi-2.3.1";
}

extern "C" JNIEXPORT jbyteArray JNICALL
Java_org_prairieserver_prairie_common_player_NativeDolbyVisionRpuConverter_nativeConvertToProfile81(
    JNIEnv *env,
    jclass,
    jbyteArray payload) {
...
Java_org_prairieserver_prairie_common_player_NativeDolbyVisionRpuConverter_nativeIsReady(
    JNIEnv *,
    jclass) {
    return JNI_TRUE;
}
...
Java_org_prairieserver_prairie_common_player_NativeDolbyVisionRpuConverter_nativeVersion(
    JNIEnv *env,
    jclass) {
