...
class MpvPlayerSourceTest {
    private val source = java.io.File(
        "src/androidMain/kotlin/org/siloserver/silo/common/player/mpv/MpvPlayer.kt",
    )
    ...
    fun mpvPlayerExposesHudControlledVideoScaleAndSyncOffsets() {
        ...
        val scaleModeSource = java.io.File(
            "src/androidMain/kotlin/org/siloserver/silo/common/player/mpv/MpvVideoScaleMode.kt",
        ).readText()
