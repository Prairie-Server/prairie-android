...
class MediaLoadRetryPolicyTest {
    ...
    fun `gateway and missing-session statuses retry with exponential backoff`() {
        assertEquals(1_000L, prairieMediaLoadRetryDelayMs(responseCode = 503, errorCount = 1))
        assertEquals(2_000L, prairieMediaLoadRetryDelayMs(responseCode = 503, errorCount = 2))
        assertEquals(4_000L, prairieMediaLoadRetryDelayMs(responseCode = 503, errorCount = 3))
        assertEquals(8_000L, prairieMediaLoadRetryDelayMs(responseCode = 503, errorCount = 4))
        assertEquals(8_000L, prairieMediaLoadRetryDelayMs(responseCode = 404, errorCount = 5))
        assertEquals(8_000L, prairieMediaLoadRetryDelayMs(responseCode = 530, errorCount = 5))
    }
    ...
    fun `non transient response codes do not retry`() {
        assertEquals(C.TIME_UNSET, prairieMediaLoadRetryDelayMs(responseCode = 401, errorCount = 1))
        assertEquals(C.TIME_UNSET, prairieMediaLoadRetryDelayMs(responseCode = 403, errorCount = 1))
        assertEquals(C.TIME_UNSET, prairieMediaLoadRetryDelayMs(responseCode = 416, errorCount = 1))
        assertEquals(C.TIME_UNSET, prairieMediaLoadRetryDelayMs(responseCode = 418, errorCount = 1))
    }
    ...
    fun `retry window eventually expires`() {
        assertEquals(C.TIME_UNSET, prairieMediaLoadRetryDelayMs(responseCode = 503, errorCount = 20))
    }
}
