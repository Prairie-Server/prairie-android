...
class PlaybackCapabilityDetectorSourceTest {
    private val source = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/common/player/PlaybackCapabilityDetector.kt",
    ).readText()
    ...
    fun detectorAdvertisesEmbeddedButNotSidecarBitmapSubtitles() {
        ...
        assertTrue(
            ...
            "Raw bitmap sidecars are not mounted into Prairie MediaItems.",
        )
    }
}
