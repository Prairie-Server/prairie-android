    ...
    fun strictRendererAcceptsTheFocusRouteAttribute() {
        ...
        val rendered = assertNotNull(
            renderer.render(
                ...
                mapOf(
                    "target" to PrairieLogAttribute.Text("content"),
                    "action" to PrairieLogAttribute.Text("entry"),
                    "route" to PrairieLogAttribute.Text("main/movies"),
                ),
            ),
        )
    ...
    fun strictRendererStillRejectsAFocusRouteOfTheWrongKind() {
        ...
        assertFailsWith<IllegalArgumentException> {
            renderer.render(
                ...
                "TvShell",
                "content entry failed",
                mapOf("route" to PrairieLogAttribute.Integer(7)),
            )
        }
    }
