...
class SubtitleMountResolverTest {
    ...
    fun catalogTextIdentityMatchesTheWebvttArtifactTheServerMaterialised() {
        ...
        val match = resolveMountedSubtitle(
            identity = identity,
            tracks = listOf(
                track(index = 0, trackId = "1:prairie-subtitle:12", language = "nl", codec = "text/vtt"),
            ),
        )
    ...
    fun bitmapIdentityStillRequiresAnExactCodecFamily() {
        ...
        val match = resolveMountedSubtitle(
            identity = identity,
            tracks = listOf(
                track(index = 0, trackId = "1:prairie-subtitle:4", language = "en", codec = "text/vtt"),
            ),
        )
    ...
    fun serverSidecarResolvesExactStableIdAcrossSameLabelTracks() {
        val tracks = listOf(
            track(index = 3, trackId = "prairie-subtitle:3", label = "Server subtitle"),
            track(index = 4, trackId = "prairie-subtitle:4", label = "Server subtitle"),
        )

        val match = resolveMountedSubtitle(SubtitleIdentity.ServerSidecar(4), tracks)

        assertEquals(4, match?.track?.index)
        assertEquals("prairie-subtitle:4", match?.track?.trackId)
    }
    ...
    fun serverDownloadedAndOrdinaryIdentityNamespacesCannotCrossMatch() {
        ...
        val tracks = listOf(
            ...
            track(
                index = 1,
                trackId = "prairie-downloaded-subtitle:99",
                label = duplicateLabel,
                language = "en",
                codec = "text/vtt",
                forced = false,
        ...
        val downloadedMedia = media(
            trackId = "prairie-downloaded-subtitle:4",
            label = duplicateLabel,
            language = "en",
            codecFamily = "webvtt",
            forced = false,
        ...
        assertNull(
            resolveMountedSubtitle(
                SubtitleIdentity.Downloaded(
                    downloadId = 99,
                    media = downloadedMedia.copy(trackId = "prairie-subtitle:3"),
                ),
    ...
    fun downloadedIdentityUsesDomainIdInsteadOfMutableArtifactIndex() {
        val tracks = listOf(
            ...
            track(
                index = 1,
                trackId = "prairie-downloaded-subtitle:313",
                label = "English",
                language = "en",
                codec = "text/vtt",
                forced = false,
        ...
        val identity = SubtitleIdentity.Downloaded(
            downloadId = 312,
            media = media(
                trackId = "prairie-downloaded-subtitle:7",
                label = "English",
                language = "en",
                codecFamily = "webvtt",
                forced = false,
    ...
    fun offAndBurnInHaveNoMountedTrack() {
        val tracks = listOf(track(index = 0, trackId = "prairie-subtitle:3"))
    ...
    fun stableArtifactIdUsesCombinedServerIndex() {
        assertEquals("prairie-subtitle:0", subtitleArtifactTrackId(0))
        assertEquals("prairie-subtitle:42", subtitleArtifactTrackId(42))
    }
