...
name: code-review
description: >-
  Review silo-push-relay (Cloudflare Worker) diffs for privacy, delivery, and quota correctness. Use when reviewing PRs or before merge.
---
...
- Logging or persisting notification content, user identities, raw device tokens, or server URLs
- Treating ambiguous APNs transport failures as safe to retry
- Committing `.dev.vars`, PEM/`.p8` keys, or tokens
- Deploying to production without explicit authorization
