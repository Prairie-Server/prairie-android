...
Neither app is authoritative for Prairie; this document records only the patterns
...
prove Prairie's Dolby Vision output, HDR signaling, AVR passthrough, subtitle
