...
- Keep `@color/prairie_icon_background` as the adaptive icon background.
...
- Screenshot the launcher and confirm the Prairie icon no longer shows a cropped square tile.
