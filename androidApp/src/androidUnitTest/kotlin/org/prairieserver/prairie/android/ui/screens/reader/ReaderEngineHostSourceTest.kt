...
class ReaderEngineHostSourceTest {
    private val sourceFile = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/reader/ReaderEngineHost.kt",
    )
    private val reflowSourceFile = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/reader/reflow/ReflowableReader.kt",
    )
    ...
    private val pdfSourceFile = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/reader/PdfReader.kt",
    )
    private val comicSourceFile = File(
        "src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/reader/ComicReader.kt",
    )
    ...
    fun `comic reader uses config-driven tap actions and reverse layout`() {
        val src = File("src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/reader/ComicReader.kt").readText()
