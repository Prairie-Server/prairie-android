...
class DownloadsSettingsParitySourceTest {
    ...
    fun downloadsSettingsExposeAppleCleanupControls() {
        val settingsScreen = File("src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/settings/SettingsScreen.kt").readText()
        val settingsViewModel = File("src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/settings/SettingsViewModel.kt").readText()
        val downloadsScreen = File("src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/downloads/DownloadsScreen.kt").readText()
        val downloadsViewModel = File("src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/downloads/DownloadsViewModel.kt").readText()
