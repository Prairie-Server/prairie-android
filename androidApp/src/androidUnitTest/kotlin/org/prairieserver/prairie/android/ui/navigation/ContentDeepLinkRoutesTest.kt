...
class ContentDeepLinkRoutesTest {
    ...
    fun playLinkCarriesValidatedVersionQualityAndTracks() {
        assertEquals(
            ...
            contentDeepLinkRouteOrNull(
                "prairie://play/movie-1?fileId=121&quality=Original&audioTrackIndex=2&subtitleTrackIndex=-1",
            ),
        )
    }
    ...
    fun playLinkDropsInvalidPlaybackParameters() {
        assertEquals(
            "player/movie-1",
            contentDeepLinkRouteOrNull(
                "prairie://play/movie-1?fileId=-5&quality=unlimited&audioTrackIndex=-2&subtitleTrackIndex=-9",
            ),
        )
    }
    ...
    fun malformedQueryEncodingDoesNotCrashPlaybackRouting() {
        assertNull(contentDeepLinkRouteOrNull("prairie://play/movie-1?quality=%"))
    }
}
