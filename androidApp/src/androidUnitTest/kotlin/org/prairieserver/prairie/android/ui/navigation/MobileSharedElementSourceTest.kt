...
class MobileSharedElementSourceTest {
    ...
    private val sharedElement = read(
        "src/androidMain/kotlin/org/prairieserver/prairie/android/ui/navigation/SharedElementTransition.kt",
    )
    ...
    private val mediaCard = read(
        "src/androidMain/kotlin/org/prairieserver/prairie/android/ui/components/MediaCard.kt",
    )
    ...
    private val similarRail = read(
        "src/androidMain/kotlin/org/prairieserver/prairie/android/ui/screens/detail/SimilarRail.kt",
    )
