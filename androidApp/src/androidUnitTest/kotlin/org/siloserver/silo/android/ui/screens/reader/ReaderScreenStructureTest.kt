...
class ReaderScreenStructureTest {
    private val screen = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/reader/ReaderScreen.kt",
    ).readText()
    private val shell = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/reader/ReaderShell.kt",
    ).readText()
