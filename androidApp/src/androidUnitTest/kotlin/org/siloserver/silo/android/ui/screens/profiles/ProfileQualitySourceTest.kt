...
class ProfileQualitySourceTest {
    private val createViewModel = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/profiles/CreateProfileViewModel.kt",
    ).readText()
    private val editViewModel = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/profiles/EditProfileViewModel.kt",
    ).readText()
    private val createScreen = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/profiles/CreateProfileScreen.kt",
    ).readText()
    private val editScreen = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/profiles/EditProfileScreen.kt",
    ).readText()
