...
class MobileListPerformanceSourceTest {
    ...
    private val catalogGrid = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/browse/CatalogGrid.kt",
    ).readText()
    ...
    private val readingHub = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/reading/ReadingHubScreen.kt",
    ).readText()
    ...
    private val personalGrid = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/personal/PersonalMediaGridContent.kt",
    ).readText()

    private val cardActionsHelpers = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/components/CardActionsHelpers.kt",
    ).readText()

    private val searchResults = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/search/SearchResults.kt",
    ).readText()

    private val requestsScreen = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/requests/RequestsScreen.kt",
    ).readText()

    private val downloadsScreen = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/downloads/DownloadsScreen.kt",
    ).readText()

    private val downloadEntryRows = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/downloads/DownloadEntryRows.kt",
    ).readText()

    private val audiobookDetail = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/audiobook/AudiobookDetailContent.kt",
    ).readText()

    private val audioTrackSelector = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/player/AudioTrackSelector.kt",
    ).readText()

    private val qualitySelector = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/player/QualitySelector.kt",
    ).readText()

    private val chaptersSheet = File(
        "src/androidMain/kotlin/org/siloserver/silo/android/ui/screens/player/ChaptersSheet.kt",
    ).readText()
