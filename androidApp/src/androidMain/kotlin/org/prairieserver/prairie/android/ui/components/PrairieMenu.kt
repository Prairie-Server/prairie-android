...
import org.prairieserver.prairie.android.ui.theme.MenuDimens
...
fun PrairieDropdownMenu(
    ...
    DropdownMenu(
        ...
        tonalElevation = 0.dp,
        border = BorderStroke(MenuDimens.borderThickness, PrairieBorder),
        content = content,
    )
}

/**
 * One row of a [PrairieDropdownMenu]: a label, and nothing else.
 *
