 ...
 * over PrairieCast and incoming TV state invalidates the Media3 timeline.
 *
...
class PrairieCastMediaSessionService : MediaSessionService() {
    ...
    override fun onCreate() {
        ...
        player = PrairieCastRemotePlayer(Looper.getMainLooper(), controller)
...
@UnstableApi
internal class PrairieCastRemotePlayer(
    looper: Looper,
    private val controller: PrairieCastController,
) : SimpleBasePlayer(looper) {
    private var playback: PrairieCastPlaybackState? = null
