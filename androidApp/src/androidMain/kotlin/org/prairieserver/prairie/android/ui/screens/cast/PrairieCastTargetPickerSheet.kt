...
/**
 * TV picker sheet, mirroring prairie-apple's `PrairieControlTargetPickerView`:
...
@Composable
fun PrairieCastTargetPickerSheet(
    launchRequest: PrairieCastLaunchRequest? = null,
    onDismiss: () -> Unit,
    onLaunched: () -> Unit = {},
    controller: PrairieCastController = koinInject(),
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                ...
                Text(
                    if (launchRequest == null) "Remote Control" else "Play on Prairie TV",
            ...
            when {
                ...
                searchTimedOut -> {
                    Column(
                        ...
                        Text(
                            "Foreground Prairie TVs on this network appear here.",
...
private fun TargetRow(
    ...
    launchRequest: PrairieCastLaunchRequest?,
