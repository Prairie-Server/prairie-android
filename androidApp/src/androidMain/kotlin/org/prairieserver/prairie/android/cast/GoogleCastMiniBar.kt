 ...
 * player while a Cast session is live. Sibling of the NSD PrairieCast mini bar
 * (which remotes Prairie's own TV app); this one controls a Chromecast receiver.
 */
@Composable
fun GoogleCastMiniBar(
    castState: PrairieCastState,
    onPlayPause: () -> Unit,
    onSkipBack: () -> Unit,
    onSkipForward: () -> Unit,
