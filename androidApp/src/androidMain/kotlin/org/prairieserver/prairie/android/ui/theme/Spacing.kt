 ...
 * `PrairieTheme.swift` already sit.
 */
object Spacing {
    val xxs = 2.dp
    val xs = 4.dp
...
object SettingsDimens {
    ...
    /** Divider opacity over [PrairieSurfaceContainer]. */
 ...
 */
val PrairieRowDividerColor = PrairieBorder.copy(alpha = SettingsDimens.dividerAlpha)
 ...
 *
 * The M3 ramp in [PrairieTypography] mirrors the iOS point sizes and has no slot
