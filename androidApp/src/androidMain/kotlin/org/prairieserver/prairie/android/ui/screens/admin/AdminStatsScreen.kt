package org.prairieserver.prairie.android.ui.screens.admin
...
import org.prairieserver.prairie.android.ui.theme.PrairieError
import org.prairieserver.prairie.android.ui.theme.PrairiePrimary
import org.prairieserver.prairie.android.ui.theme.PrairieSecondaryText
import org.prairieserver.prairie.android.ui.theme.PrairieSuccess
import org.prairieserver.prairie.android.ui.theme.PrairieSurface
import org.prairieserver.prairie.android.ui.theme.PrairieWarning
...
fun AdminStatsScreen(
    ...
    Scaffold(
        topBar = { PrairieTopBar(title = "Admin", onBackClick = onBackClick) },
...
private fun StatsGrid(stats: AdminStats) {
    ...
    val tiles = listOf(
        StatTile("Total Items", stats.totalItems.toString(), Icons.Filled.VideoLibrary, PrairiePrimary),
        StatTile("Users", stats.totalUsers.toString(), Icons.Filled.People, PrairieSuccess),
        StatTile("Movies", stats.totalMovies.toString(), Icons.Filled.Movie, PrairieWarning),
        StatTile("TV Shows", stats.totalShows.toString(), Icons.Filled.Tv, PrairiePrimary),
        StatTile("Active Streams", stats.activeStreams.toString(), Icons.Filled.PlayCircle, PrairieError),
        StatTile("Storage", formatStorageBytes(stats.totalStorageBytes), Icons.Filled.Storage, PrairieSecondaryText),
    )
    LazyVerticalGrid(
...
private fun StatCard(tile: StatTile) {
    ...
    // the value in prairieTitle, the label in prairieCaption, 16pt padding,
    // an 8pt rounded prairieSurface background.
    Surface(
        modifier = Modifier.fillMaxWidth(),
        shape = MaterialTheme.shapes.medium,
        color = PrairieSurface,
    ) {
        Column(
