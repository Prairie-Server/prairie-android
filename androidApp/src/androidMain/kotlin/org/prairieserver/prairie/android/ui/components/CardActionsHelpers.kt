 ...
 * through [org.prairieserver.prairie.viewmodel.HomeViewModel] instead so that
...
private fun org.prairieserver.prairie.network.ApiResult<Unit>.isFailure(): Boolean =
    this !is org.prairieserver.prairie.network.ApiResult.Success
