 ...
 */
class PrairieCastMediaSessionStarter(
    context: Context,
    ...
    private fun applyServiceAction(action: RemoteMediaServiceAction) {
        val intent = Intent(appContext, PrairieCastMediaSessionService::class.java)
        runCatching {
            when (action) {
    ...
    private companion object {
        const val TAG = "PrairieCastMediaStarter"
    }
}
...
private fun PrairieCastControllerState.toRemoteServiceState(): RemoteServiceState {
