...
import org.prairieserver.prairie.android.MainActivity
...
class PushNotificationPresenter(
    ...
    private fun notificationContentFor(
        ...
        if (row == null) {
            return PushNotificationContent(
                ...
                body = fallbackBody?.takeIf { it.isNotBlank() } ?: "Open Prairie to view it.",
    ...
    companion object {
        const val CHANNEL_ID = "prairie_notifications"
        const val EXTRA_DELIVERY_ID = "prairie_notification_delivery_id"
        const val EXTRA_NAV_ROUTE = "prairie_notification_nav_route"
    }
}
