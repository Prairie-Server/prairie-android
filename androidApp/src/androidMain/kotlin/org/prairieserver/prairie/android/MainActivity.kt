...
import org.prairieserver.prairie.common.startup.warmAuthenticatedStartup
import org.prairieserver.prairie.common.startup.warmProfileSelectionStartup
...
class MainActivity : ComponentActivity() {
    ...
    companion object {
        ...
        private const val EXTRA_EXTERNAL_ROUTE_CONSUMED =
            "org.prairieserver.prairie.EXTERNAL_ROUTE_CONSUMED"
        ...
        private const val STATE_CONSUMED_EXTERNAL_ROUTE =
            "org.prairieserver.prairie.CONSUMED_EXTERNAL_ROUTE"
    }
     ...
     *  - a content link (`prairie://item`, `prairie://play`) carries no identity of
    ...
    private fun hasLocalDownloads(serverId: String, profileId: String): Boolean {
        val storage = get<org.prairieserver.prairie.common.downloads.DownloadStorage>(
            org.prairieserver.prairie.common.downloads.DownloadStorage::class.java
        )
