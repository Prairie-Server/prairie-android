 ...
 * confirm button carries [PrairieDestructive] when the action destroys or
 * discards something.
 */
@Composable
fun PrairieConfirmDialog(
    title: String,
    body: String,
    confirmLabel: String,
    onConfirm: () -> Unit,
    ...
    AlertDialog(
        ...
        containerColor = PrairieSurfaceContainer,
        titleContentColor = PrairieForeground,
        textContentColor = PrairieMutedText,
        title = { Text(title) },
        text = { Text(body) },
        confirmButton = {
            TextButton(
                ...
                colors = ButtonDefaults.textButtonColors(
                    contentColor = if (destructive) PrairieDestructive else PrairieForeground,
                    disabledContentColor = (if (destructive) PrairieDestructive else PrairieForeground)
        ...
        dismissButton = {
            TextButton(
                onClick = onDismiss,
                colors = ButtonDefaults.textButtonColors(contentColor = PrairieForeground),
            ) {
                Text(dismissLabel)
            }
        },
 ...
 *   Account card has the signed-in [org.prairieserver.prairie.model.auth.User]; the
