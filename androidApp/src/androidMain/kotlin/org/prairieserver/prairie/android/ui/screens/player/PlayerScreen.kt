...
import org.prairieserver.prairie.android.cast.PrairieCastButton
import org.prairieserver.prairie.android.cast.PrairieCastOverlay
 ...
 *
 * The actual ExoPlayer lives inside [PrairiePlaybackService]; this screen
...
fun PlayerScreen(
    ...
    val castManager: org.prairieserver.prairie.android.cast.PrairieCastSessionManager = koinInject()
    ...
    val playbackRealtimeClient: org.prairieserver.prairie.network.PlaybackRealtimeClient = koinInject()
    ...
    DisposableEffect(context) {
        val sessionToken = SessionToken(
            context,
            ComponentName(context, PrairiePlaybackService::class.java),
        )
    ...
    DisposableEffect(activity) {
        onDispose {
            pictureInPictureCoordinator.clearPlaybackState(activity, PrairiePictureInPictureSurface.Mobile)
        }
    }
