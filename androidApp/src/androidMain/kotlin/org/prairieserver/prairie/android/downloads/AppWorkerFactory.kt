package org.prairieserver.prairie.android.downloads
...
import org.prairieserver.prairie.common.data.sync.SyncEngine
        ...
        return when (workerClassName) {
            ...
            DownloadSubscriptionWorker::class.java.name -> {
                ...
                DownloadSubscriptionWorker(
                    ...
                    serverRegistry = koin.get<org.prairieserver.prairie.network.ServerRegistry>(),
                    profileRepository = koin.get<org.prairieserver.prairie.repository.ProfileRepository>(),
                )
            }
