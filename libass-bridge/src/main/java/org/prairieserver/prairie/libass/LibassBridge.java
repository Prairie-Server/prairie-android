package org.prairieserver.prairie.libass;
 ...
 *
 * ass-media is Kotlin 2.2 bytecode while Prairie currently compiles Kotlin 2.1.
...
public final class LibassBridge {
    ...
    public RenderersFactory wrapRenderers(
        ...
        return new RenderersFactory() {
            ...
            public Renderer[] createRenderers(
                ...
                result[base.length] = new PrairieLibassRenderer(handler, subtitleOffsetUs);
                return result;
            }
    ...
    private static boolean probeNativeRuntime() {
        ...
        try {
            ...
            // before Prairie advertises authored ASS styling to the server.
    ...
    private static final class PrairieLibassRenderer extends NoSampleRenderer {
        private final AssHandler handler;
        private final LongSupplier subtitleOffsetUs;

        private PrairieLibassRenderer(AssHandler handler, LongSupplier subtitleOffsetUs) {
        ...
        public String getName() {
            return "PrairieLibassRenderer";
        }

        @Override
        public void render(long positionUs, long elapsedRealtimeUs) {
            // Positive Prairie offset means "show later", so render libass at an
