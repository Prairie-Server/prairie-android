...
./gradlew :shared:testDebugUnitTest \
  --tests 'org.prairieserver.prairie.network.WatchTogetherRealtimeClientTest' \
  --tests 'org.prairieserver.prairie.network.HttpOriginPolicyTest' \
  --tests 'org.prairieserver.prairie.network.PrairieAuthPluginPinTest'
```
...
./gradlew \
  :shared:testDebugUnitTest \
    --tests 'org.prairieserver.prairie.network.RoomFrameDecoderTest' \
    --tests 'org.prairieserver.prairie.network.WatchTogetherRealtimeClientTest' \
    --tests 'org.prairieserver.prairie.network.HttpOriginPolicyTest' \
    --tests 'org.prairieserver.prairie.network.PrairieAuthPluginPinTest' \
    --tests 'org.prairieserver.prairie.repository.WatchTogetherRepositoryTest' \
  :android-shared:testDebugUnitTest \
    --tests 'org.prairieserver.prairie.common.network.WatchTogetherRealtimeWebSocketTest' \
  --rerun-tasks
```
...
PrairieAuthPluginPinTest: 20 tests, 0 failures/errors
...
./gradlew :android-shared:testDebugUnitTest \
  --tests 'org.prairieserver.prairie.common.network.WatchTogetherRealtimeWebSocketTest.handshake remains entirely on captured auth scope when active identity switches'
```
...
```text
./gradlew :android-shared:testDebugUnitTest \
  --tests 'org.prairieserver.prairie.common.network.WatchTogetherRealtimeWebSocketTest.handshake fails before engine when captured scope token disappears after validation'
