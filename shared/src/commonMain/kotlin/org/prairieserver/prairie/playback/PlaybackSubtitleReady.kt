...
import org.prairieserver.prairie.model.playback.SUBTITLE_SOURCE_DOWNLOADED
...
fun decodePlaybackSubtitleReady(payload: JsonObject): PlaybackSubtitleReady {
    val track = payload["track"]?.let { element ->
        runCatching {
            PrairieJson.decodeFromJsonElement(PlaybackSubtitleInventoryItemV3.serializer(), element)
        }.getOrNull()
    }
