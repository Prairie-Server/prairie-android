 ...
 *
 * Written by [org.prairieserver.prairie.common.downloads.DownloadEnqueuer] at
 * download start and rewritten by [org.prairieserver.prairie.common.downloads.DownloadWorker]
 * on every status transition (downloading → completed / failed). Read by
 * [org.prairieserver.prairie.repository.DownloadsRepository] on init to seed the
...
data class DownloadSidecar(
    ...
    /** Stable wire string of [org.prairieserver.prairie.model.download.DownloadMediaType]
