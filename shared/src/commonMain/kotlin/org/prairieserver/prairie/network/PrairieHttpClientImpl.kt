...
/**
 * Creates a fully configured Ktor [HttpClient] for Prairie API communication.
 *
 ...
 * - **Authentication**: Custom [PrairieAuthPlugin] that manages Bearer tokens,
